...
- Si una función manipula el estado local y Supabase simultáneamente, verifica que existan bloques `try/catch` para manejar caídas de red o la transición automática al _Local Cache Mirror_.
